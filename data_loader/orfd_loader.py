...
class ORFD(data.Dataset):
    ...
    def make_sample_dataset(self):
        ...
        if self.mode != "testing":
            foot_print_path = os.path.join(
                self.data_path, "ORFD-custom", self.mode, "foot_print"
            )
            ...
            rgb_path = os.path.join(
                self.data_path, "Final_Dataset", self.mode, "image_data"
            )
