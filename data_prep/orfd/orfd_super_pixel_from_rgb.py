...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--data_root", type=str, help="Dataset directory", required=True
    )
    parser.add_argument(
        "--mode", type=str, help="training/validation/testing", required=True
    )
    ...
    file_list = os.listdir(
        os.path.join(args.data_root, "Final_Dataset", args.mode, "image_data")
    )
    for fn in tqdm(file_list):
        rgb_path = os.path.join(
            args.data_root, "Final_Dataset", args.mode, "image_data", fn
        )
